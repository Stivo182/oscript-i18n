...
Функция Спецификация()
	...
	Спецификация.Добавить(ТокенРегулярноеВыражение("^\\n", "ПереносСтроки"));
	Спецификация.Добавить(ТокенРегулярноеВыражение("^\\r", "ВозвратКаретки"));
	Спецификация.Добавить(ТокенРегулярноеВыражение("^\\t", "Табуляция"));
	Спецификация.Добавить(Новый СпецификацияТокенСимвол("\", "Экранирование"));
	Спецификация.Добавить(ТокенРегулярноеВыражение("^[=:]", "Разделитель"));
	Спецификация.Добавить(ТокенРегулярноеВыражение("^[^!#=:\\]+", "ВсёОстальное"));
