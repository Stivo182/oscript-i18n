...
Процедура ПередЗапускомТеста() Экспорт
	РегиональныеНастройки.УстановитьЛокаль("ru_RU");
	РегиональныеНастройки.УстановитьЛокальПоУмолчанию("en_UK");
КонецПроцедуры

&Тест
Процедура ТестДолжен_ПроверитьУстановкуТекущейЛокалиБезСтраны() Экспорт

	РегиональныеНастройки.УстановитьЛокаль("ru");

	Ожидаем.Что(РегиональныеНастройки.ТекущаяЛокаль(), "Локаль").Равно("ru");
	Ожидаем.Что(РегиональныеНастройки.ТекущийЯзык(), "Язык").Равно("ru");
	Ожидаем.Что(РегиональныеНастройки.ТекущаяСтрана(), "Страна").Равно("");
...
Процедура ТестДолжен_ПроверитьУстановкуТекущейЛокалиСоСтраной() Экспорт
	...
	Ожидаем.Что(РегиональныеНастройки.ТекущаяЛокаль(), "Локаль").Равно("ru_RU");
	Ожидаем.Что(РегиональныеНастройки.ТекущийЯзык(), "Язык").Равно("ru");
	Ожидаем.Что(РегиональныеНастройки.ТекущаяСтрана(), "Страна").Равно("RU");
...
Процедура ТестДолжен_ПроверитьУстановкуЛокалиПоУмолчанию() Экспорт
	...
	РегиональныеНастройки.УстановитьЛокальПоУмолчанию("ru");

	Ожидаем.Что(РегиональныеНастройки.ЛокальПоУмолчанию()).Равно("ru");
...
Процедура ТестДолжен_ПроверитьЧтоПакетыЗагружены() Экспорт
	...
	РегиональныеНастройки.УстановитьЛокальПоУмолчанию("");
